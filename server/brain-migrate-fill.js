...
function buildPrompt({ slugs, batch, batchCount }) {
  return [
    ...
    "- NEW: people/<slug>/ (person.md required; relationship.md, beliefs.md, threads.md, notes.md optional)",
    ...
    "   between Yan and them -> threads.md; remaining typed misc -> notes.md. Standing in person.md",
