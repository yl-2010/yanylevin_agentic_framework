...
export function buildLocationHistoryPrompt({ dateKey, timezone, force }) {
  ...
  return [
    ...
    "Write places.md (stays) and trips.md (walk / car / plane / uber / robotaxi / lyft).",
    "When merging a day, keep already-specific stay names (person's house, business, gym) for the same address. Do not revert them to a street number. Context synthesis at 02:30 may have corrected those lines.",
