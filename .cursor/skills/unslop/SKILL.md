...
name: unslop
description: >-
  Cut AI tells from any writing. Must always apply. Always use for every
  reply, edit, commit message, comment, and document.
---
...
One-unit replies. Never use a period when the output is only one word, one phrase, or one sentence. "Done" not "Done." Paragraphs, lists, and multi-sentence replies still use normal punctuation.
